...
import com.sxjs.jd.composition.main.cartfragment.CartFragment;
...
//        getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
    ...
    public void initView() {
        ...
        mMyCartFragment = (CartFragment) mFragmentManager.findFragmentByTag("my_cart");
        ...
        if (mMyCartFragment == null) {
            mMyCartFragment = CartFragment.newInstance();
            addFragment(R.id.main_container, mMyCartFragment, "my_cart");
        }
